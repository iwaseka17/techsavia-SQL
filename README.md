...
 
Question 12
I wrote a SQL query to display all recyclable products, sorted by product_id in descending
order.
 
 
Question 13
I wrote a SQL query to display the top 3 newest products
Tip: A higher product_id means a newer product.
